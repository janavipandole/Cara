...
// Billing sync checkbox functionality
document.addEventListener("DOMContentLoaded", () => {
  const sameBilling = document.getElementById("sameBilling");
  ...
  if (sameBilling && billingSection) {
    ...
    address.addEventListener("input", () => { if (sameBilling.checked) billingAddress.value = address.value; });
    city.addEventListener("input", () => { if (sameBilling.checked) billingCity.value = city.value; });
    zip.addEventListener("input", () => { if (sameBilling.checked) billingZip.value = zip.value; });
  }
});
