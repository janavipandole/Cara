...
// Central key used for all cart storage operations
var CART_STORAGE_KEY = "cara_cart";

/**
 * Saves the current cart array to LocalStorage.
 * Clears the entry when the cart is empty.
 * @param {Array} cart
 */
 ...
 * Returns an empty array on any error (missing key, corrupted data, etc.).
 * @returns {Array}
 */
function loadCartFromStorage() {
  try {
    ...
    // Sanitize: ensure quantity is always a positive integer
    ...
    console.warn("Cart data in LocalStorage is corrupted; resetting cart.", e);
...
window.applySharedCart = function (action) {
  ...
  var localCart = loadCartFromStorage();
