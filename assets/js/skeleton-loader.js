class SkeletonLoader {
    static render(containerId, count = 8) {
        ...
        for (let i = 0; i < count; i++) {
            ...
            card.style.cssText = 'border:1px solid #cceeec;border-radius:20px;padding:12px;margin:15px 0;width:23%;min-width:250px;animation:pulse 1.5s infinite ease-in-out;';
            card.innerHTML = `
