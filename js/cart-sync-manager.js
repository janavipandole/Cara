...
(function (root, factory) {
  ...
  class CartSyncManager {
    ...
    runWithMutex(action) {
      try {
        // Cart mutations are synchronous localStorage operations. Apply them
        // immediately to preserve the public API while still returning a
        // promise for callers that coordinate multiple mutations.
