...
document.addEventListener('DOMContentLoaded', () => {
  ...
  toc.style.cssText =
    'position:sticky; top:120px; width:220px; padding:15px; background:rgba(8,129,120,0.04); border-left:3px solid #088178; align-self:flex-start; margin-right:20px; font-family:sans-serif;';

  const tocTitle = document.createElement('h4');
  tocTitle.textContent = 'Policy Contents';
  tocTitle.style.cssText =
    'margin:0 0 10px 0; color:#088178; text-transform:uppercase; font-size:13px; font-weight:700;';
  ...
  headers.forEach((header, idx) => {
    ...
    link.style.cssText =
      'display:block; font-size:12px; margin-bottom:8px; text-decoration:none; color:#555; font-weight:500; transition:color 0.2s;';
