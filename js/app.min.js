...
window.updateQty = function (change) {
  let quantityElement = document.querySelector('.qty');
...
window.loadCart = async function () {
  ...
  let shipping = 0;
  if (subtotal > 0) shipping = subtotal >= 3e3 ? 0 : 150;
  if (shippingEl) {
  ...
  if (sortMenu && proContainer) {
    ...
    sortMenu.addEventListener('change', (e) => {
      ...
      if (sortValue === 'default') {
        ...
        productsToAppend = [...originalProducts].sort(
          (a, b) =>
...
(function () {
  ...
  window.openQuickViewModal = function (product) {
    ...
    newAddToCart.addEventListener('click', () => {
      ...
      const qty = parseInt(document.getElementById('qvQtyInput', 10).value);
