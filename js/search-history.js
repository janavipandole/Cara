...
document.addEventListener('DOMContentLoaded', () => {
  ...
  dropdown.style.cssText =
    'display:none; position:absolute; background:#fff; border:1px solid #ccc; width:100%; z-index:9999; border-radius:4px; box-shadow:0 4px 8px rgba(0,0,0,0.1); padding:10px; max-height:200px; overflow-y:auto; color: #333; top: 100%; left: 0;';
