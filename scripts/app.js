...
function ensureWishlistNavLinks() {
    ...
    if (navbar && !navbar.querySelector('a[href="../pages/wishlist.html"]')) {
        const cartLink = navbar.querySelector('a[href="../pages/cart.html"], #lg-bag');
    ...
    document.querySelectorAll(".mobile").forEach((mobileNav) => {
        if (mobileNav.querySelector('a[href="../pages/wishlist.html"]')) return;

        const cartLink = mobileNav.querySelector('a[href="../pages/cart.html"]');
