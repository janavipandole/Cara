# Order Tracking UI Timeline Component

This directory contains the premium, standalone implementation of the **Order Tracking UI Timeline** component for Cara E-Commerce.
