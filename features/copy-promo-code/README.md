# Copy to Clipboard Promo Button Component

This directory contains the premium, standalone implementation of the **Copy to Clipboard Promo Button** component for Cara E-Commerce.
